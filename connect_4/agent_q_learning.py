...
class QLearningAgent:
    ...
    def update_q_values(self, state, action, reward, next_state):
        ...
        next_best_q_value = self.q_table.get((next_state, best_next_action), 0)
        new_q_value = current_q_value + self.alpha * (reward + self.gamma * next_best_q_value - current_q_value)
